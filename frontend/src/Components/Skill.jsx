...
export default function Skill() {
  return (
    <section className="skill bg-[#252734] px-4 py-10 xl:px-10 ">
      <div className="grid md:grid-flow-col grid-flow-row md:grid-cols-2 grid-cols-1 md:max-w-[70em] mx-auto items-center ">
        <div className="md:col-span-1 p-6 order-1 md:p-10">
        ...
        <div className="md:col-span-1 order-2 md:py-0 md:p-10">
          <div className="p-6 pt-0">
            <ProgressBar
              className={"bg-[#2a2c39] p-8"}
              value={80}
              label="Communication"
              color="#3d3dd2"
              height={5}
