...
export const ContactUs = () => {
  return (
    ...
    <div className="xl:text-5xl text-2xl my-2 md:my-6 md:text-4xl text-white font-bold">You can contact me.</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="col-span-1 p-4">
            ...
            <div className="flex py-2">
              ...
              <div className='px-2'>
                <a href='https://wa.me/918419892041?text=Hello!%20I%20have%20question%20for%20your%20service.%20%0ACan%20you%20help%20me%20please%3F' rel="noreferrer" target='_blank' ><h6 className="font-bold text-[#858792] ">Whatsapp Number</h6></a>
                <a href='https://wa.me/918419892041?text=Hello!%20I%20have%20question%20for%20your%20service.%20%0ACan%20you%20help%20me%20please%3F' rel="noreferrer" target='_blank' ><p className="text-white">+91 8419892041 </p></a>
              </div>
            </div>
            <div className="flex py-2">
              <div className="p-2">
            ...
            <div className="flex py-2">
              ...
              <div className='px-2'>
                ...
                <p className="text-white text-sm">engineermishrilalsahu@gmail.com</p>
              </div>
            </div>
          </div>
          <div className="col-span-1 p-4">
