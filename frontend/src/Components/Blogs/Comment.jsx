      ...
      <div className="max-w-5xl mx-auto px-4">
        <article className="p-6 text-base  rounded-lg bg-gray-900">
          <footer className="flex justify-between items-center mb-2">
            ...
            <div
              id="dropdownComment1"
              className="hidden z-10 w-36  rounded divide-y divide-gray-100 shadow bg-gray-700 "
            >
              <ul
              ...
              >
                <li>
                  <a
                    href="#"
                    className="block py-2 px-4 hover:bg-gray-100  hover:text-white"
                  >
                    Edit
                  </a>
                </li>
        ...
        <article className="p-6 mb-3 ml-6 lg:ml-12 text-base  rounded-lg bg-gray-900">
          <footer className="flex justify-between items-center mb-2">
            ...
            <button
              ...
              className="inline-flex items-center p-2 text-sm font-medium text-center  text-gray-40  rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 bg-gray-900 "
              type="button"
            >
              <svg
                className="w-4 h-4"
        ...
        <article className="p-6 mb-3 text-base  border-t  border-gray-700 bg-gray-900">
          <footer className="flex justify-between items-center mb-2">
            <div className="flex items-center">
              <p className="inline-flex items-center mr-3 text-sm  text-white font-semibold">
                <img
